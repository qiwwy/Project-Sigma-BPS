        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Lihat daftar lengkap sekolah bekerjasama dengan BPS. Anda dapat
                        melakukan pencarian sekolah, dan penelusuran data dengan mudah.</p>
                </div>
