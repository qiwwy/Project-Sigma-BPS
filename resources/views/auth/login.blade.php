    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo" style="display: inline-flex; align-items: center;">
                        <a href="{{ route('landing.page') }}"
                            ...
                            <h1 class="sitename" style="font-size: 30px; color: white; margin: 0; font-weight: bold;">
                                BPS Kota Pekalongan</h1>
                        </a>
                    </div>
                    <h1 class="auth-title">Login Disini 👇</h1>
                    <p class="auth-subtitle mb-5">Masukkan kredensial login Anda untuk melanjutkan.</p>
            ...
            <div class="col-lg-7 col-12 d-none d-lg-block">
                <div id="auth-right" style="height: 100%;">
                    <img src="{{ asset('assets-sigma/img/bpspicture.jpeg') }}" alt="Image"
