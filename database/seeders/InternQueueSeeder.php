...
class InternQueueSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        InternQueue::create([
            'last_date_id' => $lastDateIdBR,
            'identity_number' => '21.230.1001',  // Diubah identity_number
            'name' => 'Asep Setiawan',  // Diubah nama
            'address' => 'Bandung',
            'school_name' => 'SMK Negeri Bandung Raya',  // Diubah nama sekolah
            'phone_number' => '085150021001',
